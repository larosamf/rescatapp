...
public class PersonaTest {
    public static class DummyPersona extends Usuario {
    ...
    public void donar() {
        ...
        Usuario persona = new DummyPersona(1L, new Localizacion(-50f, -50f, "prueba"), "prueba", "1234", "test@†est.com",  procesadorPagos);
        persona.setCbu(cbu);
